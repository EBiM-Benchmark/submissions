...
Your submission is a link to a **public GitHub repository** that contains:

1. a **Dockerfile** encapsulating your work, and
2. a **README** explaining how to run it.
...
- All real-robot bench testing and official evaluation are run by the organizers (see the
  [competition timeline](https://ebim-benchmark.github.io/competition.html)).

## Questions

Ask in our [Discord](https://discord.gg/pGwRbMRjuH) or see the [FAQ](https://ebim-benchmark.github.io/faq.html).
